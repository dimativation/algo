...
class TestStrategy(bt.Strategy):
    ...
    def log(self, txt=None, dt=None, order=None, price=None, cost=None, comission=None, gross=None, net=None):
        ...
        Args:
            txt ([type], optional): [description]. Defaults to None.
            dt ([type], optional): [description]. Defaults to None.
            order ([type], optional): [description]. Defaults to None.
            price ([type], optional): [description]. Defaults to None.
            cost ([type], optional): [description]. Defaults to None.
            comission ([type], optional): [description]. Defaults to None.
            gross ([type], optional): [description]. Defaults to None.
            net ([type], optional): [description]. Defaults to None.
        """
